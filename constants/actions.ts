export const MOBILITY_ACTIONS: Actions.Action[] = [
  ...
  },
  {
    ...
    label: 'マイクロツーリズム',
    description:
      '旅行や週末のレジャーを近場で過ごす（県内や隣の県への旅行、自転車圏内のレジャー）',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    label: 'コンパクトな街に住む',
    description:
      'コンパクトな町に住むことで、買い物や通院などのために移動に費やす時間を1日あたり平均10分に短縮する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    description:
      '通勤や日常的な移動にマイカーを使わず、バス・電車・自転車を利用する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    description:
      '旅行や帰省などにマイカー・飛行機・フェリーを使わず、バス・電車を利用する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    label: 'ライドシェアリング',
    description:
      '同じ目的地の人と相乗り（ライドシェア）を行うことで、マイカー・カーシェアやタクシーに4人が乗り合わせてから移動する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  ...
  },
  {
    ...
    option: 'car-ev-phv',
    category: 'mobility',
    label: 'マイカー・カーシェアを電気自動車・プラグインハイブリッド車に',
    description:
      'マイカー・カーシェアを電気自動車やプラグインハイブリッド車にする',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    category: 'mobility',
    label:
      'マイカー・カーシェアを電気自動車・プラグインハイブリッド車にして再エネで充電',
    description:
      'マイカー・カーシェアを電気自動車やプラグインハイブリッド車にし、充電を再生可能エネルギー由来の電力で行う',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  }
...
export const HOUSING_ACTIONS: Actions.Action[] = [
  ...
  },
  {
    ...
    description:
      '自宅で電力消費量のモニタリングシステム（HEMSやアプリなど）を通して節電する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  }
...
export const FOOD_ACTIONS: Actions.Action[] = [
  ...
  },
  {
    ...
    description:
      '牛肉・豚肉などを食べず、代わりに鶏肉や魚介類を食べる生活をする',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
...
export const OTHER_ACTIONS: Actions.Action[] = [
  {
    ...
    label: '衣類と宝飾品を長く使う',
    description:
      '衣類・バッグ・ジュエリーを長く使ったり、古着を活用したりすることで、1年間あたりの新規購入量を日本人平均の約4分の1にまで削減する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    label: '小型家電と家具を長く使う',
    description:
      '家具・カーペット類を壊れるまで長く大切に使い、小型家電を厳選して購入し長く使うことで、1年あたりの新規購入量を日本人平均の約4～5分の1にまで削減する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    label: '娯楽用品を長く使う',
    description:
      'エンターテインメント・スポーツ・ガーデニングなど娯楽に関する製品を厳選して購入し、長く大切に使うことで、1年間あたりの新規購入量を日本人平均の約4分の1にまで削減する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  {
    ...
    label: '消耗品を節約する',
    description:
      '化粧品・衛生用品・台所用品・文房具を節約し、1年間あたりの新規購入量を日本人平均の約半分にまで削減する',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  },
  ...
  },
  {
    ...
    description:
      'エネルギー消費の多い宿泊施設・娯楽施設（映画館、遊園地など）の代わりに、使われていないモノやスペースを活用したアウトドアやキャンプ、地域でのレクレーション（スポーツ・野外・文化活動など）で週末のレジャーや休暇を過ごす',
    reductionEffect: 0,
    actionIntensityRate: null,
    checked: false
  }
