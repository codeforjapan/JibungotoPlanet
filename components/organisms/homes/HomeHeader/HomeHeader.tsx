    ...
    <Box>
      <Box height="3vh" py={10}>
        <Box mb={10} className={styles['home__header__item-container']}>
          <HomeContentCatchPhrase className={styles['home__header__catch-phrase']}>
            じぶんごとプラネット
          </HomeContentCatchPhrase>
        </Box>
      </Box>
      <Box height="97vh" pt={10} style={{ position: 'relative' }}>
        <Box maxWidth={'660px'} className={styles['home__header__item-container']}>
          <Box pt={15}>
            <HomeContentTitle classname={styles['home__header__title-container']}>
              <span>
                気候変動を<br />
                <span className={styles['home__header__title']}>じぶんごと</span>にする
              </span>
            </HomeContentTitle>
            <HomeContentBody>
